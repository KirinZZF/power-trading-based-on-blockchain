...
const HomeScreen = ({ match }) => {
  ...
  useEffect(() => {
    ...
    //HomeScreen only shows points on selling
    console.log('client homescreen match: '+JSON.stringify(match))
    console.log('client homescreen category: '+category)
    dispatch(listProducts(keyword, pageNumber, category?category:'power'));
