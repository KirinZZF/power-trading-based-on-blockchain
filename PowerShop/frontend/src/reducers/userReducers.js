...
export const userReviewsReduer = (state = { reviews: [] }, action) => {
  switch (action.type) {
    case USER_LIST_REVIEWS_REQUEST:
      return { loading: true };
    case USER_LIST_REVIEWS_SUCCESS:
      return { loading: false, success: true, reviews: action.payload };
    case USER_LIST_REVIEWS_FAIL:
      return { loading: false, error: action.payload };
    case USER_LIST_REVIEWS_RESET:
      return {
        reviews: [],
      };
    default:
